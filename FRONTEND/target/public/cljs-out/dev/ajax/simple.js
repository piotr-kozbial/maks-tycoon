...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__29239){
...
var handler = cljs.core.get.call(null,map__29240__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__3949__auto__ = p1__29242_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__29243){
...
var request = map__29244__$1;
var interceptors = cljs.core.get.call(null,map__29244__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
