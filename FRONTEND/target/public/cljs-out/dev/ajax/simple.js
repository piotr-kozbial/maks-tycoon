...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__20481){
var map__20482 = p__20481;
var map__20482__$1 = ((((!((map__20482 == null)))?(((((map__20482.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20482.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20482):map__20482);
var handler = cljs.core.get.call(null,map__20482__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__3949__auto__ = p1__20484_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__20485){
var map__20486 = p__20485;
var map__20486__$1 = ((((!((map__20486 == null)))?(((((map__20486.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20486.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20486):map__20486);
var request = map__20486__$1;
var interceptors = cljs.core.get.call(null,map__20486__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
