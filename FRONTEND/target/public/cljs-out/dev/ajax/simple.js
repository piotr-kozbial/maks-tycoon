...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__29241){
...
var handler = cljs.core.get.call(null,map__29242__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__3949__auto__ = p1__29244_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__29245){
...
var request = map__29246__$1;
var interceptors = cljs.core.get.call(null,map__29246__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
