...
var G__25533 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__25533,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__25533;
}
});
...
var len__4531__auto___25538 = arguments.length;
var i__4532__auto___25539 = (0);
while(true){
if((i__4532__auto___25539 < len__4531__auto___25538)){
args__4534__auto__.push((arguments[i__4532__auto___25539]));

var G__25540 = (i__4532__auto___25539 + (1));
i__4532__auto___25539 = G__25540;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq25535){
var G__25536 = cljs.core.first.call(null,seq25535);
var seq25535__$1 = cljs.core.next.call(null,seq25535);
var G__25537 = cljs.core.first.call(null,seq25535__$1);
var seq25535__$2 = cljs.core.next.call(null,seq25535__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25536,G__25537,seq25535__$2);
});
...
var file = cljs.core.get.call(null,map__25542__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__25542__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__25542__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__25542,map__25542__$1,file,line,column){
return (function (p1__25541_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__25541_SHARP_));
});})(map__25542,map__25542__$1,file,line,column))
...
var temp__5457__auto___25544 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___25544)){
var message_25545 = temp__5457__auto___25544;
cljs.core.println.call(null,message_25545);
} else {
}
...
var temp__5457__auto___25546 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___25546)){
var message_25547 = temp__5457__auto___25546;
cljs.core.println.call(null,message_25547);
} else {
}
...
var output_dir__$1 = (function (){var G__25548 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__25548),"/"].join('');
} else {
return G__25548;
}
})();
...
var G__25550 = exception.stack;
var G__25550__$1 = (((G__25550 == null))?null:clojure.string.split_lines.call(null,G__25550));
var G__25550__$2 = (((G__25550__$1 == null))?null:cljs.core.get.call(null,G__25550__$1,depth));
if((G__25550__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__25550__$2);
}
} else {
...
var vec__25551 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__25551,(0),null);
var column = cljs.core.nth.call(null,vec__25551,(1),null);
var vec__25554 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__25554,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__25554,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__25554,(2),null);
...
var m__$1 = (function (){var G__25557 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__25557__$1 = (((G__25557 instanceof cljs.core.Keyword))?G__25557.fqn:null);
switch (G__25557__$1) {
case "fail":
...
var G__25561 = (function (){var G__25560 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__25560);
} else {
return G__25560;
}
})();
...
return cljs.core.vary_meta.call(null,G__25562,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__25566 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__25566,(0),null);
var types = vec__25566;
...
return cljs.core.map.call(null,(function (p__25569){
var vec__25570 = p__25569;
var ns = cljs.core.nth.call(null,vec__25570,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__25570,(1),null);
return ((function (vec__25570,ns,vars__$1){
return (function (){
...
var G__25573 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__25573,G__25573__$1,env,once_fixtures,each_fixtures,vec__25570,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__25573,G__25573__$1,env,once_fixtures,each_fixtures,vec__25570,ns,vars__$1){
return (function (){
var seq__25574 = cljs.core.seq.call(null,vars__$1);
var chunk__25575 = null;
var count__25576 = (0);
var i__25577 = (0);
while(true){
if((i__25577 < count__25576)){
var v = cljs.core._nth.call(null,chunk__25575,i__25577);
var temp__5457__auto___25579 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___25579)){
var t_25580 = temp__5457__auto___25579;
each_fixture_fn.call(null,((function (seq__25574,chunk__25575,count__25576,i__25577,t_25580,temp__5457__auto___25579,v,each_fixture_fn,G__25573,G__25573__$1,env,once_fixtures,each_fixtures,vec__25570,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_25580)));
});})(seq__25574,chunk__25575,count__25576,i__25577,t_25580,temp__5457__auto___25579,v,each_fixture_fn,G__25573,G__25573__$1,env,once_fixtures,each_fixtures,vec__25570,ns,vars__$1))
);
} else {
}


var G__25581 = seq__25574;
var G__25582 = chunk__25575;
var G__25583 = count__25576;
var G__25584 = (i__25577 + (1));
seq__25574 = G__25581;
chunk__25575 = G__25582;
count__25576 = G__25583;
i__25577 = G__25584;
continue;
} else {
...
var G__25585 = cljs.core.chunk_rest.call(null,seq__25574__$1);
var G__25586 = c__4351__auto__;
var G__25587 = cljs.core.count.call(null,c__4351__auto__);
var G__25588 = (0);
seq__25574 = G__25585;
chunk__25575 = G__25586;
count__25576 = G__25587;
i__25577 = G__25588;
continue;
} else {
var v = cljs.core.first.call(null,seq__25574__$1);
var temp__5457__auto___25589__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___25589__$1)){
var t_25590 = temp__5457__auto___25589__$1;
each_fixture_fn.call(null,((function (seq__25574,chunk__25575,count__25576,i__25577,t_25590,temp__5457__auto___25589__$1,v,seq__25574__$1,temp__5457__auto__,each_fixture_fn,G__25573,G__25573__$1,env,once_fixtures,each_fixtures,vec__25570,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_25590)));
});})(seq__25574,chunk__25575,count__25576,i__25577,t_25590,temp__5457__auto___25589__$1,v,seq__25574__$1,temp__5457__auto__,each_fixture_fn,G__25573,G__25573__$1,env,once_fixtures,each_fixtures,vec__25570,ns,vars__$1))
);
} else {
}


var G__25591 = cljs.core.next.call(null,seq__25574__$1);
var G__25592 = null;
var G__25593 = (0);
var G__25594 = (0);
seq__25574 = G__25591;
chunk__25575 = G__25592;
count__25576 = G__25593;
i__25577 = G__25594;
continue;
}
} else {
...
});})(each_fixture_fn,G__25573,G__25573__$1,env,once_fixtures,each_fixtures,vec__25570,ns,vars__$1))
);
});})(each_fixture_fn,G__25573,G__25573__$1,env,once_fixtures,each_fixtures,vec__25570,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__25573__$1)].join('')));

}
})());
});
;})(vec__25570,ns,vars__$1))
