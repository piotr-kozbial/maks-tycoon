...
var G__27260 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__27260,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__27260;
}
});
...
var len__4531__auto___27265 = arguments.length;
var i__4532__auto___27266 = (0);
while(true){
if((i__4532__auto___27266 < len__4531__auto___27265)){
args__4534__auto__.push((arguments[i__4532__auto___27266]));

var G__27267 = (i__4532__auto___27266 + (1));
i__4532__auto___27266 = G__27267;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq27262){
var G__27263 = cljs.core.first.call(null,seq27262);
var seq27262__$1 = cljs.core.next.call(null,seq27262);
var G__27264 = cljs.core.first.call(null,seq27262__$1);
var seq27262__$2 = cljs.core.next.call(null,seq27262__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27263,G__27264,seq27262__$2);
});
...
var file = cljs.core.get.call(null,map__27269__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__27269__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__27269__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__27269,map__27269__$1,file,line,column){
return (function (p1__27268_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__27268_SHARP_));
});})(map__27269,map__27269__$1,file,line,column))
...
var temp__5457__auto___27271 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___27271)){
var message_27272 = temp__5457__auto___27271;
cljs.core.println.call(null,message_27272);
} else {
}
...
var temp__5457__auto___27273 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___27273)){
var message_27274 = temp__5457__auto___27273;
cljs.core.println.call(null,message_27274);
} else {
}
...
var output_dir__$1 = (function (){var G__27275 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__27275),"/"].join('');
} else {
return G__27275;
}
})();
...
var G__27277 = exception.stack;
var G__27277__$1 = (((G__27277 == null))?null:clojure.string.split_lines.call(null,G__27277));
var G__27277__$2 = (((G__27277__$1 == null))?null:cljs.core.get.call(null,G__27277__$1,depth));
if((G__27277__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__27277__$2);
}
} else {
...
var vec__27278 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__27278,(0),null);
var column = cljs.core.nth.call(null,vec__27278,(1),null);
var vec__27281 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__27281,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__27281,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__27281,(2),null);
...
var m__$1 = (function (){var G__27284 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__27288 = (function (){var G__27287 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__27287);
} else {
return G__27287;
}
})();
...
return cljs.core.vary_meta.call(null,G__27289,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__27293 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__27293,(0),null);
var types = vec__27293;
...
return cljs.core.map.call(null,(function (p__27296){
var vec__27297 = p__27296;
var ns = cljs.core.nth.call(null,vec__27297,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__27297,(1),null);
return ((function (vec__27297,ns,vars__$1){
return (function (){
...
var G__27300 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__27300,G__27300__$1,env,once_fixtures,each_fixtures,vec__27297,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__27300,G__27300__$1,env,once_fixtures,each_fixtures,vec__27297,ns,vars__$1){
return (function (){
var seq__27301 = cljs.core.seq.call(null,vars__$1);
var chunk__27302 = null;
var count__27303 = (0);
var i__27304 = (0);
while(true){
if((i__27304 < count__27303)){
var v = cljs.core._nth.call(null,chunk__27302,i__27304);
var temp__5457__auto___27306 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___27306)){
var t_27307 = temp__5457__auto___27306;
each_fixture_fn.call(null,((function (seq__27301,chunk__27302,count__27303,i__27304,t_27307,temp__5457__auto___27306,v,each_fixture_fn,G__27300,G__27300__$1,env,once_fixtures,each_fixtures,vec__27297,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_27307)));
});})(seq__27301,chunk__27302,count__27303,i__27304,t_27307,temp__5457__auto___27306,v,each_fixture_fn,G__27300,G__27300__$1,env,once_fixtures,each_fixtures,vec__27297,ns,vars__$1))
);
} else {
}


var G__27308 = seq__27301;
var G__27309 = chunk__27302;
var G__27310 = count__27303;
var G__27311 = (i__27304 + (1));
seq__27301 = G__27308;
chunk__27302 = G__27309;
count__27303 = G__27310;
i__27304 = G__27311;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__27301);
if(temp__5457__auto__){
var seq__27301__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__27301__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__27301__$1);
var G__27312 = cljs.core.chunk_rest.call(null,seq__27301__$1);
var G__27313 = c__4351__auto__;
var G__27314 = cljs.core.count.call(null,c__4351__auto__);
var G__27315 = (0);
seq__27301 = G__27312;
chunk__27302 = G__27313;
count__27303 = G__27314;
i__27304 = G__27315;
continue;
} else {
var v = cljs.core.first.call(null,seq__27301__$1);
var temp__5457__auto___27316__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___27316__$1)){
var t_27317 = temp__5457__auto___27316__$1;
each_fixture_fn.call(null,((function (seq__27301,chunk__27302,count__27303,i__27304,t_27317,temp__5457__auto___27316__$1,v,seq__27301__$1,temp__5457__auto__,each_fixture_fn,G__27300,G__27300__$1,env,once_fixtures,each_fixtures,vec__27297,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_27317)));
});})(seq__27301,chunk__27302,count__27303,i__27304,t_27317,temp__5457__auto___27316__$1,v,seq__27301__$1,temp__5457__auto__,each_fixture_fn,G__27300,G__27300__$1,env,once_fixtures,each_fixtures,vec__27297,ns,vars__$1))
);
} else {
}


var G__27318 = cljs.core.next.call(null,seq__27301__$1);
var G__27319 = null;
var G__27320 = (0);
var G__27321 = (0);
seq__27301 = G__27318;
chunk__27302 = G__27319;
count__27303 = G__27320;
i__27304 = G__27321;
continue;
}
} else {
...
});})(each_fixture_fn,G__27300,G__27300__$1,env,once_fixtures,each_fixtures,vec__27297,ns,vars__$1))
);
});})(each_fixture_fn,G__27300,G__27300__$1,env,once_fixtures,each_fixtures,vec__27297,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__27300__$1)].join('')));

}
})());
});
;})(vec__27297,ns,vars__$1))
