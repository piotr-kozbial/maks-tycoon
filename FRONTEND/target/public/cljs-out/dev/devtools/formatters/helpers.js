...
var G__25552 = devtools.prefs.pref.call(null,v);
v = G__25552;
continue;
} else {
return v;
...
}catch (e25555){var _e__24569__auto__ = e25555;
return false;
}})();
...
}catch (e25559){var _e__24569__auto__ = e25559;
return false;
}})();
...
}catch (e25561){var _e__24569__auto__ = e25561;
return false;
}}
}
});
...
var vec__25563 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__25563,(0),null);
var name = cljs.core.nth.call(null,vec__25563,(1),null);
...
return cljs.core.some.call(null,(function (p1__25566_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__25566_SHARP_);
}),template);
});
