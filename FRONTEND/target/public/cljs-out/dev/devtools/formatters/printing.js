...
var len__4531__auto___32565 = arguments.length;
var i__4532__auto___32566 = (0);
while(true){
if((i__4532__auto___32566 < len__4531__auto___32565)){
args__4534__auto__.push((arguments[i__4532__auto___32566]));

var G__32567 = (i__4532__auto___32566 + (1));
i__4532__auto___32566 = G__32567;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq32562){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32563,G__32564,seq32562__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__32568_SHARP_){
return !((cljs.core.meta.call(null,p1__32568_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__32569__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e32573){var _e__31553__auto__ = e32573;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e32575){var _e__31553__auto__ = e32575;
return false;
}}
})())){
...
var _STAR_current_state_STAR_32577 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__32578 = opts;
...
var markup_db = cljs.core.get.call(null,map__32578__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_32577;
}});
...
;
var temp__5455__auto___32582 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___32582)){
var managed_print_level_32583 = temp__5455__auto___32582;
var _STAR_print_level_STAR_32581_32584 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_32583;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_32581_32584,managed_print_level_32583,temp__5455__auto___32582,writer,opts,job_fn){
return (function (p1__32580_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__32580_SHARP_,null);
});})(_STAR_print_level_STAR_32581_32584,managed_print_level_32583,temp__5455__auto___32582,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_32581_32584;
}} else {
job_fn.call(null);
}
