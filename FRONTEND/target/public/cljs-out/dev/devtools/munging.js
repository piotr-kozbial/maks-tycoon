...
var o23398 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23398["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23399 = temp__5455__auto____$1;
return (o23399["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22510__auto__ = f;
return (o__22510__auto__["toString"]).call(o__22510__auto__);
} else {
return "";
}
...
try{var o__22510__auto___23402 = t;
(o__22510__auto___23402["cljs$lang$ctorPrWriter"]).call(o__22510__auto___23402,t,writer);
}catch (e23401){var __23403 = e23401;
}
...
var char_code = (function (){var o__22510__auto__ = (new String(char$));
return (o__22510__auto__["charCodeAt"]).call(o__22510__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22510__auto__ = String;
return (o__22510__auto__["fromCharCode"]).call(o__22510__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23404 = num_code;
switch (G__23404) {
case (1):
return (185);
...
var o__22510__auto__ = String;
return (o__22510__auto__["fromCharCode"]).call(o__22510__auto__,superscript_code);
});
/**
...
}catch (e23406){var _e__22517__auto__ = e23406;
return false;
}})())){
...
var vec__23407 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23407,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o23410 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23410["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23411 = temp__5455__auto____$1;
return (o23411["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23414){
var vec__23415 = p__23414;
var ns_detector = cljs.core.nth.call(null,vec__23415,(0),null);
...
var G__23421 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23422 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23421;
remaining_tokens = G__23422;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23412){
var G__23413 = cljs.core.first.call(null,seq23412);
var seq23412__$1 = cljs.core.next.call(null,seq23412);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23413,seq23412__$1);
});
...
var vec__23426 = cljs.core.split_with.call(null,(function (p1__23425_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23425_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23426,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23426,(1),null);
...
var vec__23429 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23429,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23429,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23432 = cljs.core.rest.call(null,remaining_tokens);
var G__23433 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23432;
name_tokens = G__23433;
continue;
} else {
...
var vec__23436 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23436,(0),null);
var arity = cljs.core.nth.call(null,vec__23436,(1),null);
var vec__23439 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23439,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23439,(1),null);
var vec__23442 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23442,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23442,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23442,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23442,(3),null);
...
var vec__23448 = result;
var munged_ns = cljs.core.nth.call(null,vec__23448,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23448,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23448,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23448,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23448,(4),null);
var arity = cljs.core.nth.call(null,vec__23448,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__23452 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__23452,(0),null);
var args = cljs.core.nth.call(null,vec__23452,(1),null);
var vec__23455 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23455,(0),null);
var name = cljs.core.nth.call(null,vec__23455,(1),null);
...
var G__23458 = (arity + (1));
var G__23459 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23460){
var vec__23461 = p__23460;
var arity = cljs.core.nth.call(null,vec__23461,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23461,(1),null);
...
return cljs.core.get.call(null,arities,p1__23464_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__23465_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___23472 = arguments.length;
var i__4532__auto___23473 = (0);
while(true){
if((i__4532__auto___23473 < len__4531__auto___23472)){
args__4534__auto__.push((arguments[i__4532__auto___23473]));

var G__23474 = (i__4532__auto___23473 + (1));
i__4532__auto___23473 = G__23474;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23468){
var vec__23469 = p__23468;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23469,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23466){
var G__23467 = cljs.core.first.call(null,seq23466);
var seq23466__$1 = cljs.core.next.call(null,seq23466);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23467,seq23466__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__23477__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23477__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23477__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23477__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23478 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23478,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23478,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23478,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23478,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23478,(4),null);
var arity = cljs.core.nth.call(null,vec__23478,(5),null);
...
var o__22510__auto__ = f;
return (o__22510__auto__["getBasis"]).call(o__22510__auto__);
});
/**
...
}catch (e23482){var _e__22517__auto__ = e23482;
...
var G__23483 = (obj[cljs.core.first.call(null,path)]);
var G__23484 = cljs.core.rest.call(null,path);
obj = G__23483;
path = G__23484;
continue;
} else {
...
return (function (accum,p__23485){
var vec__23486 = p__23485;
var bit = cljs.core.nth.call(null,vec__23486,(0),null);
var protocol = cljs.core.nth.call(null,vec__23486,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23489){
var vec__23490 = p__23489;
var ns = cljs.core.nth.call(null,vec__23490,(0),null);
var name = cljs.core.nth.call(null,vec__23490,(1),null);
var selector = cljs.core.nth.call(null,vec__23490,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__23495,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23495,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__23495,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__23493_SHARP_){
return (obj[cljs.core.first.call(null,p1__23493_SHARP_)]);
});})(name,sorted_matches,vec__23495,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
