...
var o25450 = temp__5455__auto__;
var temp__5455__auto____$1 = (o25450["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o25451 = temp__5455__auto____$1;
return (o25451["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__24562__auto__ = f;
return (o__24562__auto__["toString"]).call(o__24562__auto__);
} else {
return "";
}
...
try{var o__24562__auto___25454 = t;
(o__24562__auto___25454["cljs$lang$ctorPrWriter"]).call(o__24562__auto___25454,t,writer);
}catch (e25453){var __25455 = e25453;
}
...
var char_code = (function (){var o__24562__auto__ = (new String(char$));
return (o__24562__auto__["charCodeAt"]).call(o__24562__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__24562__auto__ = String;
return (o__24562__auto__["fromCharCode"]).call(o__24562__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__25456 = num_code;
switch (G__25456) {
case (1):
return (185);
...
var o__24562__auto__ = String;
return (o__24562__auto__["fromCharCode"]).call(o__24562__auto__,superscript_code);
});
/**
...
}catch (e25458){var _e__24569__auto__ = e25458;
return false;
}})())){
...
var vec__25459 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__25459,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o25462 = temp__5455__auto__;
var temp__5455__auto____$1 = (o25462["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o25463 = temp__5455__auto____$1;
return (o25463["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__25466){
var vec__25467 = p__25466;
var ns_detector = cljs.core.nth.call(null,vec__25467,(0),null);
...
var G__25473 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__25474 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__25473;
remaining_tokens = G__25474;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq25464){
var G__25465 = cljs.core.first.call(null,seq25464);
var seq25464__$1 = cljs.core.next.call(null,seq25464);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25465,seq25464__$1);
});
...
var vec__25478 = cljs.core.split_with.call(null,(function (p1__25477_SHARP_){
return cljs.core.not_EQ_.call(null,p1__25477_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__25478,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__25478,(1),null);
...
var vec__25481 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__25481,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__25481,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__25484 = cljs.core.rest.call(null,remaining_tokens);
var G__25485 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__25484;
name_tokens = G__25485;
continue;
} else {
...
var vec__25488 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__25488,(0),null);
var arity = cljs.core.nth.call(null,vec__25488,(1),null);
var vec__25491 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__25491,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__25491,(1),null);
var vec__25494 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__25494,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__25494,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__25494,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__25494,(3),null);
...
var vec__25500 = result;
var munged_ns = cljs.core.nth.call(null,vec__25500,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__25500,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__25500,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__25500,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__25500,(4),null);
var arity = cljs.core.nth.call(null,vec__25500,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__25504 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__25504,(0),null);
var args = cljs.core.nth.call(null,vec__25504,(1),null);
var vec__25507 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__25507,(0),null);
var name = cljs.core.nth.call(null,vec__25507,(1),null);
...
var G__25510 = (arity + (1));
var G__25511 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__25512){
var vec__25513 = p__25512;
var arity = cljs.core.nth.call(null,vec__25513,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__25513,(1),null);
...
return cljs.core.get.call(null,arities,p1__25516_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__25517_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___25524 = arguments.length;
var i__4532__auto___25525 = (0);
while(true){
if((i__4532__auto___25525 < len__4531__auto___25524)){
args__4534__auto__.push((arguments[i__4532__auto___25525]));

var G__25526 = (i__4532__auto___25525 + (1));
i__4532__auto___25525 = G__25526;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__25520){
var vec__25521 = p__25520;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__25521,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq25518){
var G__25519 = cljs.core.first.call(null,seq25518);
var seq25518__$1 = cljs.core.next.call(null,seq25518);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25519,seq25518__$1);
});
...
var map__25529 = options;
var map__25529__$1 = ((((!((map__25529 == null)))?(((((map__25529.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__25529.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__25529):map__25529);
var include_ns_QMARK_ = cljs.core.get.call(null,map__25529__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__25529__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__25529__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__25529__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__25530 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__25530,(0),null);
var fn_name = cljs.core.nth.call(null,vec__25530,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__25530,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__25530,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__25530,(4),null);
var arity = cljs.core.nth.call(null,vec__25530,(5),null);
...
var o__24562__auto__ = f;
return (o__24562__auto__["getBasis"]).call(o__24562__auto__);
});
/**
...
}catch (e25534){var _e__24569__auto__ = e25534;
...
var G__25535 = (obj[cljs.core.first.call(null,path)]);
var G__25536 = cljs.core.rest.call(null,path);
obj = G__25535;
path = G__25536;
continue;
} else {
...
return (function (accum,p__25537){
var vec__25538 = p__25537;
var bit = cljs.core.nth.call(null,vec__25538,(0),null);
var protocol = cljs.core.nth.call(null,vec__25538,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__25541){
var vec__25542 = p__25541;
var ns = cljs.core.nth.call(null,vec__25542,(0),null);
var name = cljs.core.nth.call(null,vec__25542,(1),null);
var selector = cljs.core.nth.call(null,vec__25542,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__25547,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__25547,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__25547,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__25545_SHARP_){
return (obj[cljs.core.first.call(null,p1__25545_SHARP_)]);
});})(name,sorted_matches,vec__25547,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
