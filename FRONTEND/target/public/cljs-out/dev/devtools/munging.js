...
var o32434 = temp__5455__auto__;
var temp__5455__auto____$1 = (o32434["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o32435 = temp__5455__auto____$1;
return (o32435["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__31546__auto__ = f;
return (o__31546__auto__["toString"]).call(o__31546__auto__);
} else {
return "";
}
}catch (e32436){var _ = e32436;
return "";
}});
...
try{var o__31546__auto___32438 = t;
(o__31546__auto___32438["cljs$lang$ctorPrWriter"]).call(o__31546__auto___32438,t,writer);
}catch (e32437){var __32439 = e32437;
}
...
var char_code = (function (){var o__31546__auto__ = (new String(char$));
return (o__31546__auto__["charCodeAt"]).call(o__31546__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__31546__auto__ = String;
return (o__31546__auto__["fromCharCode"]).call(o__31546__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__32440 = num_code;
switch (G__32440) {
case (1):
return (185);
...
var o__31546__auto__ = String;
return (o__31546__auto__["fromCharCode"]).call(o__31546__auto__,superscript_code);
});
/**
...
}catch (e32442){var _e__31553__auto__ = e32442;
return false;
}})())){
...
var vec__32443 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__32443,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o32446 = temp__5455__auto__;
var temp__5455__auto____$1 = (o32446["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o32447 = temp__5455__auto____$1;
return (o32447["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___32454 = arguments.length;
var i__4532__auto___32455 = (0);
while(true){
if((i__4532__auto___32455 < len__4531__auto___32454)){
args__4534__auto__.push((arguments[i__4532__auto___32455]));

var G__32456 = (i__4532__auto___32455 + (1));
i__4532__auto___32455 = G__32456;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__32450){
var vec__32451 = p__32450;
var ns_detector = cljs.core.nth.call(null,vec__32451,(0),null);
...
var G__32457 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__32458 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__32457;
remaining_tokens = G__32458;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq32448){
var G__32449 = cljs.core.first.call(null,seq32448);
var seq32448__$1 = cljs.core.next.call(null,seq32448);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32449,seq32448__$1);
});
...
var vec__32462 = cljs.core.split_with.call(null,(function (p1__32461_SHARP_){
return cljs.core.not_EQ_.call(null,p1__32461_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__32462,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__32462,(1),null);
...
var vec__32465 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__32465,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__32465,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__32468 = cljs.core.rest.call(null,remaining_tokens);
var G__32469 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__32468;
name_tokens = G__32469;
continue;
} else {
...
var vec__32472 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__32472,(0),null);
var arity = cljs.core.nth.call(null,vec__32472,(1),null);
var vec__32475 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__32475,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__32475,(1),null);
var vec__32478 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__32478,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__32478,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__32478,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__32478,(3),null);
...
var vec__32484 = result;
var munged_ns = cljs.core.nth.call(null,vec__32484,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__32484,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__32484,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__32484,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__32484,(4),null);
var arity = cljs.core.nth.call(null,vec__32484,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__32488 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__32488,(0),null);
var args = cljs.core.nth.call(null,vec__32488,(1),null);
var vec__32491 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__32491,(0),null);
var name = cljs.core.nth.call(null,vec__32491,(1),null);
...
var G__32494 = (arity + (1));
var G__32495 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__32496){
var vec__32497 = p__32496;
var arity = cljs.core.nth.call(null,vec__32497,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__32497,(1),null);
...
return cljs.core.get.call(null,arities,p1__32500_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__32501_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___32508 = arguments.length;
var i__4532__auto___32509 = (0);
while(true){
if((i__4532__auto___32509 < len__4531__auto___32508)){
args__4534__auto__.push((arguments[i__4532__auto___32509]));

var G__32510 = (i__4532__auto___32509 + (1));
i__4532__auto___32509 = G__32510;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__32504){
var vec__32505 = p__32504;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__32505,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq32502){
var G__32503 = cljs.core.first.call(null,seq32502);
var seq32502__$1 = cljs.core.next.call(null,seq32502);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32503,seq32502__$1);
});
...
var map__32513__$1 = ((((!((map__32513 == null)))?(((((map__32513.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__32513.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__32513):map__32513);
var include_ns_QMARK_ = cljs.core.get.call(null,map__32513__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__32513__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__32513__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__32513__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__32514 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__32514,(0),null);
var fn_name = cljs.core.nth.call(null,vec__32514,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__32514,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__32514,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__32514,(4),null);
var arity = cljs.core.nth.call(null,vec__32514,(5),null);
...
var o__31546__auto__ = f;
return (o__31546__auto__["getBasis"]).call(o__31546__auto__);
});
/**
...
}catch (e32518){var _e__31553__auto__ = e32518;
...
var G__32519 = (obj[cljs.core.first.call(null,path)]);
var G__32520 = cljs.core.rest.call(null,path);
obj = G__32519;
path = G__32520;
continue;
} else {
...
return (function (accum,p__32521){
var vec__32522 = p__32521;
var bit = cljs.core.nth.call(null,vec__32522,(0),null);
var protocol = cljs.core.nth.call(null,vec__32522,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__32525){
var vec__32526 = p__32525;
var ns = cljs.core.nth.call(null,vec__32526,(0),null);
var name = cljs.core.nth.call(null,vec__32526,(1),null);
var selector = cljs.core.nth.call(null,vec__32526,(2),null);
...
return (function (p__32530){
var vec__32531 = p__32530;
var munged_name = cljs.core.nth.call(null,vec__32531,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__32531,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__32531,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__32529_SHARP_){
return (obj[cljs.core.first.call(null,p1__32529_SHARP_)]);
});})(name,sorted_matches,vec__32531,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
