...
var map__20040 = new cljs.core.Keyword(null,"attrs","attrs",-2090668713).cljs$core$IFn$_invoke$arity$1(doc);
...
var width = cljs.core.get.call(null,map__20040__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.call(null,map__20040__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var tilewidth = cljs.core.get.call(null,map__20040__$1,new cljs.core.Keyword(null,"tilewidth","tilewidth",-711038610));
var tileheight = cljs.core.get.call(null,map__20040__$1,new cljs.core.Keyword(null,"tileheight","tileheight",1971050793));
...
return cljs.core.filter.call(null,(function (p1__20042_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(p1__20042_SHARP_),new cljs.core.Keyword(null,"tileset","tileset",-1285577730));
...
var map__20044 = new cljs.core.Keyword(null,"attrs","attrs",-2090668713).cljs$core$IFn$_invoke$arity$1(tileset_subdoc);
...
var firstgid = cljs.core.get.call(null,map__20044__$1,new cljs.core.Keyword(null,"firstgid","firstgid",1659571107));
var name = cljs.core.get.call(null,map__20044__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var tilewidth = cljs.core.get.call(null,map__20044__$1,new cljs.core.Keyword(null,"tilewidth","tilewidth",-711038610));
var tileheight = cljs.core.get.call(null,map__20044__$1,new cljs.core.Keyword(null,"tileheight","tileheight",1971050793));
var tilecount = cljs.core.get.call(null,map__20044__$1,new cljs.core.Keyword(null,"tilecount","tilecount",-1061649439));
var columns = cljs.core.get.call(null,map__20044__$1,new cljs.core.Keyword(null,"columns","columns",1998437288));
var image_subdoc = cljs.core.first.call(null,cljs.core.filter.call(null,((function (map__20044,map__20044__$1,firstgid,name,tilewidth,tileheight,tilecount,columns){
return (function (p1__20043_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(p1__20043_SHARP_),new cljs.core.Keyword(null,"image","image",-58725096));
});})(map__20044,map__20044__$1,firstgid,name,tilewidth,tileheight,tilecount,columns))
,new cljs.core.Keyword(null,"content","content",15833224).cljs$core$IFn$_invoke$arity$1(tileset_subdoc)));
var map__20045 = new cljs.core.Keyword(null,"attrs","attrs",-2090668713).cljs$core$IFn$_invoke$arity$1(image_subdoc);
var map__20045__$1 = ((((!((map__20045 == null)))?(((((map__20045.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20045.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20045):map__20045);
var source = cljs.core.get.call(null,map__20045__$1,new cljs.core.Keyword(null,"source","source",-433931539));
var width = cljs.core.get.call(null,map__20045__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.call(null,map__20045__$1,new cljs.core.Keyword(null,"height","height",1025178622));
...
return cljs.core.apply.call(null,cljs.core.hash_map,cljs.core.mapcat.call(null,(function (p__20048){
...
var tileset = map__20049__$1;
var name = cljs.core.get.call(null,map__20049__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
return cljs.core.filter.call(null,(function (p1__20051_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(p1__20051_SHARP_),new cljs.core.Keyword(null,"layer","layer",-1601820589));
}),new cljs.core.Keyword(null,"content","content",15833224).cljs$core$IFn$_invoke$arity$1(doc));
});
gamebase.tmx.parse_layer = (function gamebase$tmx$parse_layer(layer_subdoc){
var map__20054 = new cljs.core.Keyword(null,"attrs","attrs",-2090668713).cljs$core$IFn$_invoke$arity$1(layer_subdoc);
var map__20054__$1 = ((((!((map__20054 == null)))?(((((map__20054.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20054.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20054):map__20054);
var name = cljs.core.get.call(null,map__20054__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var width = cljs.core.get.call(null,map__20054__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.call(null,map__20054__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var layer_width = gamebase.tmx.parse_int.call(null,width);
var layer_height = gamebase.tmx.parse_int.call(null,height);
var data = cljs.core.first.call(null,cljs.core.filter.call(null,((function (map__20054,map__20054__$1,name,width,height,layer_width,layer_height){
return (function (p1__20052_SHARP_){
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(p1__20052_SHARP_),new cljs.core.Keyword(null,"data","data",-232669377));
});})(map__20054,map__20054__$1,name,width,height,layer_width,layer_height))
...
return new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"name","name",1843675177),name,new cljs.core.Keyword(null,"width","width",-384071477),layer_width,new cljs.core.Keyword(null,"height","height",1025178622),layer_height,new cljs.core.Keyword(null,"id-list","id-list",-408015824),cljs.core.map.call(null,gamebase.tmx.parse_int,((function (id_list,map__20054,map__20054__$1,name,width,height,layer_width,layer_height,data){
return (function (p1__20053_SHARP_){
return clojure.string.split.call(null,p1__20053_SHARP_,/,/);
});})(id_list,map__20054,map__20054__$1,name,width,height,layer_width,layer_height,data))
...
return cljs.core.apply.call(null,cljs.core.hash_map,cljs.core.mapcat.call(null,(function (p__20056){
...
var tileset = map__20057__$1;
var name = cljs.core.get.call(null,map__20057__$1,new cljs.core.Keyword(null,"name","name",1843675177));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [name,tileset], null);
