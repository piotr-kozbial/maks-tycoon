...
return cljs.core.second.call(null,cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__36303_SHARP_){
return cljs.core._EQ_.call(null,cljs.core.first.call(null,p1__36303_SHARP_),layer_key);
...
var vec__36305 = gamebase.layers.get_tile_from_layer.call(null,layer,tile_x,tile_y);
var _ = cljs.core.nth.call(null,vec__36305,(0),null);
var tile_number = cljs.core.nth.call(null,vec__36305,(1),null);
var tile = app.tiles.general.tiles_by_number.call(null,tile_number);
return cljs.core.swap_BANG_.call(null,app.state.app_state,cljs.core.update_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"world","world",-418292623),new cljs.core.Keyword(null,"tile-extra","tile-extra",1451483079)], null),((function (layer,vec__36305,_,tile_number,tile){
return (function (m){
return cljs.core.assoc.call(null,m,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [tile_x,tile_y], null),cljs.core.some.call(null,((function (layer,vec__36305,_,tile_number,tile){
return (function (p1__36304_SHARP_){
return app.tiles.general.initialize_tile_extra.call(null,p1__36304_SHARP_,tile_x,tile_y,tile);
});})(layer,vec__36305,_,tile_number,tile))
