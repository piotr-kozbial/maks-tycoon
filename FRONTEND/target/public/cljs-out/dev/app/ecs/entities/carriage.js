...
return cljs.core.second.call(null,cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__46068_SHARP_){
return cljs.core._EQ_.call(null,cljs.core.first.call(null,p1__46068_SHARP_),layer_key);
...
return cljs.core.apply.call(null,cljs.core.hash_map,cljs.core.mapcat.call(null,(function (p__46069){
var vec__46070 = p__46069;
var tx = cljs.core.nth.call(null,vec__46070,(0),null);
var ty = cljs.core.nth.call(null,vec__46070,(1),null);
var track = cljs.core.nth.call(null,vec__46070,(2),null);
...
var track = cljs.core.get.call(null,map__46073__$1,new cljs.core.Keyword(null,"track","track",195787487));
var tile_x = cljs.core.get.call(null,map__46073__$1,new cljs.core.Keyword(null,"tile-x","tile-x",1338121882));
var tile_y = cljs.core.get.call(null,map__46073__$1,new cljs.core.Keyword(null,"tile-y","tile-y",-1293098706));
var vec__46074 = app.tiles.general.track_destination_tile.call(null,track,tile_x,tile_y);
var new_tile_x = cljs.core.nth.call(null,vec__46074,(0),null);
var new_tile_y = cljs.core.nth.call(null,vec__46074,(1),null);
...
var vec__46077 = new cljs.core.Keyword(null,"track","track",195787487).cljs$core$IFn$_invoke$arity$1(this$);
var _ = cljs.core.nth.call(null,vec__46077,(0),null);
var tile_end = cljs.core.nth.call(null,vec__46077,(1),null);
...
var this$ = map__46082__$1;
var rear_coupling = cljs.core.get.call(null,map__46082__$1,new cljs.core.Keyword(null,"rear-coupling","rear-coupling",1106253524));
...
cljs.core._add_method.call(null,gamebase.ecs.handle_event,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"to-entity","to-entity",-34052624),new cljs.core.Keyword("app.ecs.entities.carriage","carriage","app.ecs.entities.carriage/carriage",1924650460),new cljs.core.Keyword("app.ecs.common-events","drive","app.ecs.common-events/drive",-677702491)], null),(function (world,event,p__46084){
...
var this$ = map__46085__$1;
var rear_coupling = cljs.core.get.call(null,map__46085__$1,new cljs.core.Keyword(null,"rear-coupling","rear-coupling",1106253524));
...
cljs.core._add_method.call(null,gamebase.ecs.handle_event,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"to-entity","to-entity",-34052624),new cljs.core.Keyword("app.ecs.entities.carriage","carriage","app.ecs.entities.carriage/carriage",1924650460),new cljs.core.Keyword("app.ecs.entities.carriage","couple-rear","app.ecs.entities.carriage/couple-rear",548779996)], null),(function (world,p__46087,this$){
...
var event = map__46088__$1;
var the_other_id = cljs.core.get.call(null,map__46088__$1,new cljs.core.Keyword(null,"the-other-id","the-other-id",-1798540769));
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.assoc.call(null,this$,new cljs.core.Keyword(null,"image","image",-58725096),(function (){var G__46090 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.boolean$.call(null,new cljs.core.Keyword(null,"front-coupling","front-coupling",2000992378).cljs$core$IFn$_invoke$arity$1(this$)),cljs.core.boolean$.call(null,new cljs.core.Keyword(null,"rear-coupling","rear-coupling",1106253524).cljs$core$IFn$_invoke$arity$1(this$))], null);
if(cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [false,false], null),G__46090)){
return "carriage1.png";
} else {
if(cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [true,false], null),G__46090)){
return "carriage1-front-coupled.png";
} else {
if(cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [false,true], null),G__46090)){
return "carriage1-rear-coupled.png";
} else {
if(cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [true,true], null),G__46090)){
return "carriage1-both-coupled.png";
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__46090)].join('')));
