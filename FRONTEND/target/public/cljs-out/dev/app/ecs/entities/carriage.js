...
return cljs.core.second.call(null,cljs.core.first.call(null,cljs.core.filter.call(null,(function (p1__67199_SHARP_){
return cljs.core._EQ_.call(null,cljs.core.first.call(null,p1__67199_SHARP_),layer_key);
...
return cljs.core.apply.call(null,cljs.core.hash_map,cljs.core.mapcat.call(null,(function (p__67200){
var vec__67201 = p__67200;
var tx = cljs.core.nth.call(null,vec__67201,(0),null);
var ty = cljs.core.nth.call(null,vec__67201,(1),null);
var track = cljs.core.nth.call(null,vec__67201,(2),null);
...
var map__67204 = this$;
var map__67204__$1 = ((((!((map__67204 == null)))?(((((map__67204.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__67204.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__67204):map__67204);
var track = cljs.core.get.call(null,map__67204__$1,new cljs.core.Keyword(null,"track","track",195787487));
var tile_x = cljs.core.get.call(null,map__67204__$1,new cljs.core.Keyword(null,"tile-x","tile-x",1338121882));
var tile_y = cljs.core.get.call(null,map__67204__$1,new cljs.core.Keyword(null,"tile-y","tile-y",-1293098706));
var vec__67205 = app.tiles.general.track_destination_tile.call(null,track,tile_x,tile_y);
var new_tile_x = cljs.core.nth.call(null,vec__67205,(0),null);
var new_tile_y = cljs.core.nth.call(null,vec__67205,(1),null);
...
var vec__67208 = new cljs.core.Keyword(null,"track","track",195787487).cljs$core$IFn$_invoke$arity$1(this$);
var _ = cljs.core.nth.call(null,vec__67208,(0),null);
var tile_end = cljs.core.nth.call(null,vec__67208,(1),null);
...
cljs.core._add_method.call(null,gamebase.ecs.handle_event,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"to-entity","to-entity",-34052624),new cljs.core.Keyword("app.ecs.entities.carriage","carriage","app.ecs.entities.carriage/carriage",1924650460),new cljs.core.Keyword("app.ecs.common-events","stop","app.ecs.common-events/stop",-1144685785)], null),(function (world,event,p__67212){
var map__67213 = p__67212;
var map__67213__$1 = ((((!((map__67213 == null)))?(((((map__67213.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__67213.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__67213):map__67213);
var this$ = map__67213__$1;
var rear_coupling = cljs.core.get.call(null,map__67213__$1,new cljs.core.Keyword(null,"rear-coupling","rear-coupling",1106253524));
...
cljs.core._add_method.call(null,gamebase.ecs.handle_event,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"to-entity","to-entity",-34052624),new cljs.core.Keyword("app.ecs.entities.carriage","carriage","app.ecs.entities.carriage/carriage",1924650460),new cljs.core.Keyword("app.ecs.common-events","drive","app.ecs.common-events/drive",-677702491)], null),(function (world,event,p__67215){
var map__67216 = p__67215;
var map__67216__$1 = ((((!((map__67216 == null)))?(((((map__67216.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__67216.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__67216):map__67216);
var this$ = map__67216__$1;
var rear_coupling = cljs.core.get.call(null,map__67216__$1,new cljs.core.Keyword(null,"rear-coupling","rear-coupling",1106253524));
...
cljs.core._add_method.call(null,gamebase.ecs.handle_event,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"to-entity","to-entity",-34052624),new cljs.core.Keyword("app.ecs.entities.carriage","carriage","app.ecs.entities.carriage/carriage",1924650460),new cljs.core.Keyword("app.ecs.entities.carriage","couple-rear","app.ecs.entities.carriage/couple-rear",548779996)], null),(function (world,p__67218,this$){
var map__67219 = p__67218;
var map__67219__$1 = ((((!((map__67219 == null)))?(((((map__67219.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__67219.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__67219):map__67219);
var event = map__67219__$1;
var the_other_id = cljs.core.get.call(null,map__67219__$1,new cljs.core.Keyword(null,"the-other-id","the-other-id",-1798540769));
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.assoc.call(null,this$,new cljs.core.Keyword(null,"image","image",-58725096),(function (){var G__67221 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.boolean$.call(null,new cljs.core.Keyword(null,"front-coupling","front-coupling",2000992378).cljs$core$IFn$_invoke$arity$1(this$)),cljs.core.boolean$.call(null,new cljs.core.Keyword(null,"rear-coupling","rear-coupling",1106253524).cljs$core$IFn$_invoke$arity$1(this$))], null);
if(cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [false,false], null),G__67221)){
return "carriage1.png";
} else {
if(cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [true,false], null),G__67221)){
return "carriage1-front-coupled.png";
} else {
if(cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [false,true], null),G__67221)){
return "carriage1-rear-coupled.png";
} else {
if(cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [true,true], null),G__67221)){
return "carriage1-both-coupled.png";
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__67221)].join('')));
